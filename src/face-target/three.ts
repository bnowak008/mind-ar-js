...
export class MindARThree {
  ...
  _startAR() {
    return new Promise(async (resolve, reject) => {
      ...
      this.controller.onUpdate = ({ hasFace, estimateResult }: {hasFace: boolean, estimateResult: any}) => {
        ...
        if (hasFace) {
          ...
          for (let i = 0; i < this.anchors.length; i++) {
            ...
            if (this.anchors[i].css) {
              ...
              this.anchors[i].group.matrix.set(...scaledElements as [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number]);
            } else {
              this.anchors[i].group.matrix.set(...landmarkMatrix as [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number]);
            }
          }
          for (let i = 0; i < this.faceMeshes.length; i++) {
            this.faceMeshes[i].matrix.set(...faceMatrix as [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number]);
          }
        } else {
          this.latestEstimate = null;
        }

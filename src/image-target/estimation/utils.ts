const buildModelViewProjectionTransform = (projectionTransform: number[][], modelViewTransform: number[][]) => {
...
const applyModelViewProjectionTransform = (modelViewProjectionTransform: number[][], x: number, y: number, z: number) => {
  // assume z is zero
...
const computeScreenCoordiate = (modelViewProjectionTransform: number[][], x: number, y: number, z: number) => {
...
const screenToMarkerCoordinate = (modelViewProjectionTransform: number[][], sx: number, sy: number) => {

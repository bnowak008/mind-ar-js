...
type ComputeOrientationHistogramsArgs = {
  inputs: {
    gaussianImagesT: TensorInfo[];
    prunedExtremasT: TensorInfo;
    radialPropertiesT: TensorInfo;
    pyramidImagesLength: number;
  };
  backend: MathBackendCPU;
};

const cache: Record<string, [CPUKernel, CPUKernel]> = {};
function GetPrograms(prunedExtremasT: TensorInfo, radialPropertiesT: TensorInfo, pyramidImagesLength: number): [CPUKernel, CPUKernel] {
...
export const computeOrientationHistograms = (args: ComputeOrientationHistogramsArgs): TensorInfo => {
...
export const computeOrientationHistogramsConfig: KernelConfig = {

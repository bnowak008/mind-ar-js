...
type ExtremaReductionArgs = {
  inputs: { extremasResultT: TensorInfo };
  backend: MathBackendCPU;
};

function GetProgram(outHeight: number, outWidth: number): CPUKernel {
  const kernel = {
...
export const extremaReduction = (args: ExtremaReductionArgs): TensorInfo => {

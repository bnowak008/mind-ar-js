...
type ComputeExtremaFreakArgs = {
  inputs: {
    gaussianImagesT: TensorInfo[];
    prunedExtremas: TensorInfo;
    prunedExtremasAngles: TensorInfo;
    freakPointsT: TensorInfo;
    pyramidImagesLength: number;
  };
  backend: MathBackendCPU;
};

function GetProgram(prunedExtremasHeight: number, pyramidImagesLength: number): CPUKernel {
...
export const computeExtremaFreak = (args: ComputeExtremaFreakArgs): TensorInfo => {

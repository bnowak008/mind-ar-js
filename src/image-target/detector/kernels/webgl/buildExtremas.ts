...
import type { Tensor, Rank, KernelConfig, TensorInfo } from '@tensorflow/tfjs';
...
type BuildExtremasArgs = {
  inputs: { image0: Tensor<Rank>; image1: Tensor<Rank>; image2: Tensor<Rank> };
  backend: MathBackendWebGL;
};

const cache: Record<string, WebGLKernel> = {};
function GetProgram(image: Tensor<Rank>): WebGLKernel {
...
export const buildExtremas=(args: BuildExtremasArgs): TensorInfo=>{

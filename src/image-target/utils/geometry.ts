...
const checkFourPointsConsistent = (x1: Point2D, x2: Point2D, x3: Point2D, x4: Point2D, x1p: Point2D, x2p: Point2D, x3p: Point2D, x4p: Point2D): boolean => {
...
const checkThreePointsConsistent = (x1: Point2D, x2: Point2D, x3: Point2D, x1p: Point2D, x2p: Point2D, x3p: Point2D): boolean => {
  if ((linePointSide(x1, x2, x3) > 0) !== (linePointSide(x1p, x2p, x3p) > 0)) return false;
  return true;
};

const determinant = (A: Matrix33): number => {
...
const matrixInverse33 = (A: Matrix33, threshold: number): Matrix33 | null => {
...
const matrixMul33 = (A: Matrix33, B: Matrix33): Matrix33 => {
  const C = new Array(9) as Matrix33;
...
const multiplyPointHomographyInhomogenous = (x: Point2D, H: Matrix33): Point2D => {
...
const smallestTriangleArea = (x1: Point2D, x2: Point2D, x3: Point2D, x4: Point2D): number => {
...
const quadrilateralConvex = (x1: Point2D, x2: Point2D, x3: Point2D, x4: Point2D): boolean => {
...
const _vector = (a: Point2D, b: Point2D): Point2D => {
  return [a[0] - b[0], a[1] - b[1]];
};

const _areaOfTriangle = (u: Point2D, v: Point2D): number => {

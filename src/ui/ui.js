//import "./ui.scss";
import loadingHTML from './loading.html' with { type: "text" };
import compatibilityHTML from './compatibility.html' with { type: "text" };
import scanningHTML from './scanning.html' with { type: "text" };
